...
import { Shield, LayoutDashboard, Brain, Users, FileText, Menu, X, Rocket, Terminal } from 'lucide-react';
...
const navLinks = [
    ...
    { name: 'Gallery', href: '/gallery', icon: <FileText size={18} /> },
    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                {/* Mobile Toggle */}
                <button
                    className="xl:hidden p-2 text-text-muted transition-colors"
